...
-- CreateEnum
CREATE TYPE "ServiceType" AS ENUM ('GENERAL_CLEANING', 'DEEP_CLEANING', 'RESIDENTIAL_CLEANING');
...
-- CreateEnum
CREATE TYPE "serviceType" AS ENUM ('RESIDENTIAL_CLEANING');
...
CREATE TABLE "cleaner_verifications" (
    ...
    CONSTRAINT "cleaner_verifications_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "reviews_booking_id_homeowner_id_cleaner_id_key" ON "reviews"("booking_id", "homeowner_id", "cleaner_id");
...
-- AddForeignKey
ALTER TABLE "cleaner_verifications" ADD CONSTRAINT "cleaner_verifications_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_cleaner_id_fkey" FOREIGN KEY ("cleaner_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
